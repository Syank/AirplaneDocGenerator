...
class CardOption extends React.Component {
    ...
    getIconComponent(iconName){
        ...
        switch (iconName) {
            case "file":
                component = <FontAwesomeIcon icon={faFile} size={this.iconSize} color={this.iconColor}/>

                break;
            
            case "edit":
                component = <FontAwesomeIcon icon={faEdit} size={this.iconSize} color={this.iconColor}/>

                break;

            case "print":
                component = <FontAwesomeIcon icon={faPrint} size={this.iconSize} color={this.iconColor}/>
    ...
    getCardOption(){
        ...
        let cardOption = (
            <div className="w-56 h-80 bg-white flex flex-col items-center p-5 justify-around shadow-simpleShadow">
                ...
                <Button text={this.buttonText} type="confirm" onClick={this.buttonOnClick}></Button>
            </div>
        );
